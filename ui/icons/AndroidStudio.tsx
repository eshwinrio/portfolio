...
const AndroidStudioIcon: FC<SvgIconProps> = (props) => {
    return (
        <SvgIcon viewBox="0 0 128 128" {...props}>
            <path d="M51.3 17.7H23.2C17.6 17.7 13 22.3 13 28c-.2 5.5 4.2 10.1 9.7 10.3h28.9l-.3-20.6z" />
            ...
            <path d="M105.6 58.1h-4.2c-.2.1-.4.3-.4.6v66.5c0 .3.2.5.5.5h4.4c5.1 0 9.2-4.2 9.2-9.2V48.8c0 5.1-4.1 9.2-9.2 9.2h-.3z" />
        </SvgIcon>
    )
}
